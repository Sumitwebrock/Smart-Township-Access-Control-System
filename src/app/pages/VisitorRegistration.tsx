      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-card border border-border rounded-[16px] p-6 mb-6 shadow-sm">
          ...
          <div className="relative aspect-video bg-secondary border border-border rounded-[12px] overflow-hidden mb-4">
            ...
            {scanState === 'error' && (
              <div className="absolute bottom-3 inset-x-3 px-4 py-2 rounded-[10px] bg-red-600 text-white flex items-center gap-2">
                <AlertCircle className="w-4 h-4 shrink-0" />
                <span className="text-sm font-semibold">OCR failed – enter plate manually</span>
              </div>
            )}
          </div>
